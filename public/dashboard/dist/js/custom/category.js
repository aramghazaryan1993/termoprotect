...
$(document).on('click', '.add-todo', function (e) {
    ...
    var todoListData = `
              ...
              <input value="`+ todoInputData +`" type="text" name="names[`+i+`][name]" class="form-control" placeholder="Enter value">
              <input style="margin-left: 5px;height: 20px;width: 20px" type="checkbox" name="names[`+i+`][status]">
              <input style="margin-left: 5px" type="file" name="names[`+i+`][image]">
