...
@section('content')
    ...
    <div class="card card-dark">
        ...
        <br>
        <form role="form" action="{{ route('admin.menus.update',$menu->id) }}" method="POST" enctype="multipart/form-data"
              id="news_form">
            @csrf
            @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <div class="image-container">
                            ...
                            @php
                                ...
                                if ($extension === 'gif') {
                                   $imgUrl = $menu->getFirstMediaUrl('menu_banner');
                                } else {
                                    $imgUrl = $menu->getFirstMediaUrl('menu_banner','mobile');
                                }
                            @endphp
                        ...
                        <div class="img__wrap" style="padding: 10px 10px 10px 10px">
                            <img id="data_img" style="max-height: 100px;" class="img__img"
                                 src="{{ $menu->getFirstMediaUrl('menu', 'mobile') }}"/>
            ...
            <div class="tab-content">
                @foreach(\App\Models\Menu::lang as $key => $val)
                    ...
                    <div id="{{$val['value']}}" @if($val['value'] == 'hy') class="tab-pane active form-group"
                        ...
                        @foreach($menu->localizations as $value)
                            @if($value->lang == $val['value'])
                                ...
                                <div class="col-10 form-group">
                                    ...
                                    <input value="{{ $value->slug }}" type="text"
                                ...
                                <div class="col-10 form-group">
                                    ...
                                    <input value="{{ $value->seo_title }}" type="text"
                                ...
                                <div class="col-lg-10 form-group" style="align-items: center; width: 500px;">
                                    ...
                                    <textarea name="langs[{{$val['value']}}][seo_description]" rows="5" style="width: 120%"
                                              ...
                                              class="form-control">{{ $value->seo_description }}</textarea>
                                </div>
                                ...
                                <div class="col-lg-10 form-group" style="align-items: center; width: 500px;">
                                    ...
                                    <textarea name="langs[{{$val['value']}}][seo_keyword]" rows="5" style="width: 120%"
                                              ...
                                              class="form-control">{{ $value->seo_keyword }}</textarea>
                                </div>
                            @endif
                        @endforeach
                    </div>
