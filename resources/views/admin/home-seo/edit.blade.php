...
@section('content')
    ...
    <div class="card card-dark">
        ...
        <form role="form" action="{{ route('admin.home.seo.update') }}" method="post" id="news_form"
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        @foreach(\App\Models\HomeSeo::lang as $lang)
                            <li class="nav-item">
                    ...
                    <div class="tab-content">
                        ...
                        @foreach(\App\Models\HomeSeo::lang as $val)
                            <div id="{{$val['value']}}"
                                 class="tab-pane @if($val['value'] == 'hy') active @endif form-group"><br>
                                <div class="row">
                                    @foreach($homes->localizations as $home)
                                        @if($home->lang == $val['value'])
                                            <div class="col-lg-3">
                                                <div class="col-20">
                                                    <label for="">SEO Title</label>
                                                    <input value="{{$home->seo_title}}" type="text"
                                                ...
                                                <div class="col-lg-20" style="align-items: center; width: 500px;">
                                                    ...
                                                    <textarea name="langs[{{$val['value']}}][seo_description]" rows="5"
                                                              ...
                                                              class="form-control">{{$home->seo_description}}</textarea>
                                                </div>
                                                ...
                                                <div class="col-lg-20" style="align-items: center; width: 500px;">
                                                    ...
                                                    <textarea name="langs[{{$val['value']}}][seo_keyword]" rows="5"
                                                              ...
                                                              class="form-control">{{$home->seo_keyword}}</textarea>
                                                </div>
